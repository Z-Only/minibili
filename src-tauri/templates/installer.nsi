; This file is copied from https://github.com/tauri-apps/tauri/blob/tauri-v2/tooling/bundler/src/bundle/windows/templates/installer.nsi
; and edit to fit the needs of the project.
